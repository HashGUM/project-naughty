...
void initialize_llama_module(ModuleInitializationLevel p_level) {
    ...
    ClassDB::register_class<LlamaInference>();
}
...
extern "C" {
    // 初始化入口点
    GDExtensionBool GDE_EXPORT llama_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
